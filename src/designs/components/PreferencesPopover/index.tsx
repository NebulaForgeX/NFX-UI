import type { AccentColorEnum, GrayColorEnum } from "@/enums/theme";
...
import { AccentColor, Appearance, GrayColor, PanelBackground, Radius, RadiusEnum, Scaling } from "@/enums/theme";
import { LANGUAGE_VALUES, Language as LanguageHelper } from "@/languages/types";
import { useBaseLabel, useLanguageLabel } from "@/languages/hooks";
import { useSyncPreference } from "@/hooks/preference";
        ...
        <Flex direction="column" gap="3" width="100%">
          ...
          <Flex direction="column" gap="1">
            ...
            <SegmentedControl.Root
              ...
              onValueChange={(next) => {
                if (next) syncPreference({ language: LanguageHelper(next) });
              }}
              size="1"
            >
